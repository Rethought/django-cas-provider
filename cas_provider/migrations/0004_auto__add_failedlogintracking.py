...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FailedLoginTracking'
        db.create_table('cas_provider_failedlogintracking', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('username', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('login_attempt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('cas_provider', ['FailedLoginTracking'])


    def backwards(self, orm):
        # Deleting model 'FailedLoginTracking'
        db.delete_table('cas_provider_failedlogintracking')
    ...
    models = {
        ...
        'cas_provider.failedlogintracking': {
            'Meta': {'object_name': 'FailedLoginTracking'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login_attempt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
